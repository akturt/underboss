...
#
# One-liner installer for Documentation System Runtime v1.5.
...
if [ -f "$PROJECT_ROOT/$SUBMODULE_PATH/runtime/registry.yaml" ]; then
  echo "→ Runtime v1.5 already installed. Running bootstrap..."
...
echo ""
echo "Commit with:"
echo "  git add -A && git commit -m 'docs: install Documentation System Runtime v1.5'"
